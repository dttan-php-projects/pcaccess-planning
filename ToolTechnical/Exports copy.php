<?php
    ...
    if (mysqli_num_rows($statement) > 0 ) {
        ...
        // $data = mysqli_fetch_all($statement, MYSQLI_ASSOC);
        // print_r($data); exit();
        ...
        while($element = mysqli_fetch_assoc($statement)) {
            ...
            // if ($index%500 == 0 ) ob_clean(); // xóa cache
    ...
    // ============== OUTPUT ==============================================
        ...
        $filename = 'PC_MasterData_' . date("Y_m_d__H_i_s");
    ...
    function loadData($max, $spreadsheet )
    {
