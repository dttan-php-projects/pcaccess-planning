<?php 
    ...
    InitPage("PCTrimCardOption","Trim Card Option List");
?>
...
<script>
    ...
    function DocumentStart()
    {
        ...
        LayoutMain = new dhtmlXLayoutObject({
            ...
            cells: [
                {id: "a", header: true, text: "Trim Card List"}
            ]
        });
    ...
    function InitGrid(){
        ...
        GridMain.setHeader("STT,RBO, BILL TO CUSTOMER, SHIP TO CUSTOMER, FORM TRIM CARD");
        GridMain.setInitWidths("50,*,*,*,150");
        GridMain.setColumnMinWidth("50,150,150,150,150");
        GridMain.setColAlign("center,center,center,center,center");
        GridMain.setColTypes("ro,ed,ed,ed,ed");
        ...
        GridMain.init();
        GridMain.load("Data.php?EVENT=LOADTRIMOPTIONAL",function(){
            var LastRow = GridMain.getRowsNum();
            if(LastRow == 0 || GridMain.cells2(LastRow - 1,3).getValue() != "") {
                AddRowGrid(LastRow);
            }
        });
        dp = new dataProcessor("Data.php?EVENT=LOADTRIMOPTIONAL");
        dp.init(GridMain);
