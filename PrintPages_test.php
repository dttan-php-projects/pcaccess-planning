<?php 
	...
	CS_Sample, DS_Sample, Hot_Folder, SubContract_detail,Special_Instruction, FSC,RemarkPage, DieCut_Machine, Special_Drying_Time FROM $table_information WHERE GLID = '$GLID';", _conn());
	if(!empty($RowItem)) {
		$R = $RowItem[0];
