...
if (!empty($CREATE_DATE)) {
    $CREATE_DATE_TEXT = '<span style="color:red;font-weight:bold;"> || AUTOMAIL UPDATED: '.date('d-M, Y H:i',strtotime($CREATE_DATE)) . "</span>";
} else {
    $CREATE_DATE_TEXT = '|| AUTOMAIL UPDATED: loading... ';
}
?>
<!DOCTYPE html>
<html>
...
<script>
    ...
    var LayoutMain;
    var CREATE_DATE_TEXT = '<?php echo $CREATE_DATE_TEXT; ?>';
    ...
    function inAutomailGrid() {
        ...
        inAutomailGrid.attachHeader(",#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
    ...
    function outAutomailGrid() {
        ...
        outAutomailGrid.attachHeader(",#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
    ...
    function MasterItemToolbar() {
        ...
        MasterItemToolbar.addText("automail_updated", 2, CREATE_DATE_TEXT);
